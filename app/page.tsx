...
export default function Home() {
  ...
  return <main dir={localizationLanguage === 'ar' ? 'rtl' : 'ltr'}>
    ...
    <footer id="contact"><p>{localizationLanguage === 'ar' ? 'متاحة للتعاونات الإبداعية' : 'Available for creative collaborations'}</p><div className="contact-links"><a href="https://iwtsp.com/966534197558" target="_blank" rel="noreferrer" aria-label="WhatsApp"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M20.5 3.5A11.8 11.8 0 0 0 12.1 0C5.6 0 .3 5.3.3 11.8c0 2.1.6 4.1 1.6 5.8L.2 24l6.6-1.7a11.7 11.7 0 0 0 5.3 1.3h.1c6.5 0 11.8-5.3 11.8-11.8 0-3.2-1.2-6.1-3.5-8.3Zm-8.4 18.1h-.1a9.7 9.7 0 0 1-4.9-1.3l-.4-.2-3.9 1 1-3.8-.3-.4a9.8 9.8 0 1 1 8.6 4.7Zm5.4-7.4c-.3-.2-1.8-.9-2.1-1s-.5-.2-.7.2-.8 1-.9 1.1-.3.2-.6.1c-1.8-.9-3-1.6-4.2-3.7-.3-.5.3-.5.9-1.7.1-.2.1-.4 0-.6l-1-2.3c-.2-.5-.5-.4-.7-.4h-.6c-.2 0-.6.1-.9.5s-1.2 1.2-1.2 3 .1 2.9 1.3 4.7c1.2 1.8 2.7 3.2 4.7 4.1 2.4 1.1 3.3 1.2 4.5 1s1.8-.8 2-1.5.2-1.3.1-1.4-.3-.2-.6-.4Z" /></svg></a><a href="https://deem-alosili.vidsarb22.chatgpt.site/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M5.2 3.3a2.2 2.2 0 1 1 0 4.4 2.2 2.2 0 0 1 0-4.4ZM3.3 9h3.8v11.7H3.3V9Zm6.2 0h3.6v1.6h.1c.5-.9 1.8-2 3.8-2 4 0 4.8 2.7 4.8 6.1v6.1H18v-5.4c0-1.3 0-3-1.9-3s-2.2 1.5-2.2 2.9v5.5H9.5V9Z" /></svg></a><a href="mailto:deem.alosaili@gmail.com" aria-label="Email"><Mail /></a></div></footer>
